            ...
            <div class="">
                <div class="col-6 offset-3">
                    ...
                    <div class="form-group row">
                        ...
                        <input id="phone_number" type="number" class="form-control @error('phone_number') is-invalid @enderror" name="phone_number" value="{{ old('phone_number') ?? $teacher->phone_number }}" autocomplete="phone_number" autofocus>
